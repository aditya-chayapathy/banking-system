Public Class Branch_Manager_Log_In_History
    ...
    Private Sub Branch_Manager_Log_In_History_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim conn As New OleDb.OleDbConnection("Provider=MSDAORA;Data Source=aditya;User ID=aditya; Password=aditya;")
        conn.Open()
        Dim cmd As New OleDb.OleDbCommand("SELECT * FROM LOG_IN WHERE EMP_NO=?", conn)
