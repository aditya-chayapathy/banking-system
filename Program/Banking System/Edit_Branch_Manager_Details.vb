Public Class Edit_Branch_Manager_Details
    ...
    Private Sub HowToEditMyDetailsToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles HowToEditMyDetailsToolStripMenuItem.Click
        MessageBox.Show("Make necessary changes to the fields provied and click on the 'save' button", "How To Edit My Details ?", MessageBoxButtons.OK)
    End Sub
    ...
    Private Sub Edit_Branch_Manager_Details_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim conn As New OleDb.OleDbConnection("Provider=MSDAORA;Data Source=aditya;User ID=aditya; Password=aditya;")
        conn.Open()
