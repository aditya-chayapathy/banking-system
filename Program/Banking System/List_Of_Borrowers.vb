Public Class List_Of_Borrowers
    ...
    Private Sub List_Of_Borrowers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim conn As New OleDb.OleDbConnection("Provider=MSDAORA;Data Source=aditya;User ID=aditya; Password=aditya;")
        conn.Open()
        ...
        Dim cmd As New OleDb.OleDbCommand("SELECT * FROM BORROWER,CUSTOMER WHERE BO_ACC_NO=CUS_ACC_NO AND CUS_BRANCH=?", conn)
