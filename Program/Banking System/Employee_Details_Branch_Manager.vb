Public Class Employee_Details_Branch_Manager
    ...
    Private Sub HowToViewEmployeeDetailsToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles HowToViewEmployeeDetailsToolStripMenuItem.Click
        MessageBox.Show("Enter the employee no in the search space provided and click on the 'Search' button", "How To View Employee Details ?", MessageBoxButtons.OK)
    End Sub
