Public Class Branch_Manager_Details
    ...
    Private Sub HowToEditMyDetailsToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles HowToEditMyDetailsToolStripMenuItem.Click
        MessageBox.Show("Click on the 'Edit My Details' button to make changes to your details", " How To Edit My Details?", MessageBoxButtons.OK)
    End Sub

    Private Sub Branch_Manager_Details_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim conn As New OleDb.OleDbConnection("Provider=MSDAORA;Data Source=aditya;User ID=aditya; Password=aditya;")
        conn.Open()
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Me.Hide()
        Edit_Branch_Manager_Details.Show()
    End Sub
End Class