Public Class Customer_Details
    ...
    Private Sub HowToSearchToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles HowToSearchToolStripMenuItem.Click
        MessageBox.Show("STEP 1  -  Enter the account no of the customer whose details is to be displayed." + System.Environment.NewLine + "STEP 2  -  Click on the 'Search' button to obtain the details", "How To Search ?", MessageBoxButtons.OK, MessageBoxIcon.Information)
    End Sub
